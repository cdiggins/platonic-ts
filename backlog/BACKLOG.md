...
|----|-------|------|-----|--------|------|------|--------|--------|
| [BL-0016](BL-0016-code-overview-browser.md) | Build a code overview browser separate from the observability dashboard | feature | p2 | L | med | repo | in-progress |  |
| [BL-0004](BL-0004-hooks-events.md) | Claude Code hooks emit events | feature | p3 | M | med | dashboard | in-progress |  |
